...
const OpenSource = () => {
  ...
  // Hidden data - will be used when ready
  const contributions = [
    {
      id: "os1",
      repo: "react/react",
        ...
        <div className="bg-white dark:bg-[#1A1A1E] rounded-lg p-12 border border-gray-200 dark:border-[#3D5AFE]/20 text-center">
          <div className="flex items-center justify-center mb-6">
            <div className="bg-[#3D5AFE]/20 p-6 rounded-full">
              <Clock size={48} className="text-[#3D5AFE]" />
            </div>
          </div>
          ...
          <p className="text-gray-600 dark:text-[#A0A0A0] text-lg max-w-2xl mx-auto">
            I'm currently working on exciting open source contributions and projects. Check back soon to see my latest work and contributions to the community!
          </p>
        </div>
